    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Edit Invoice</h1>
            <p className="text-slate-600 mt-2 text-sm sm:text-base">{invoice.invoiceNumber}</p>
          </div>
        </div>
